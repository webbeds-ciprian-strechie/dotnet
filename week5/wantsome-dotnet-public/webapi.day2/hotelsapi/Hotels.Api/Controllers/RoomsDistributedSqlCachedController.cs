namespace Hotels.Api.Controllers
{
    ...
    [Route("api/hotels/{hotelId}/dis-sql-cached-rooms")]
    [ApiController]
    public class RoomsDistributedSqlCachedController : ControllerBase
    {
        private readonly ApiDbContext context;
        private readonly ISimpleLogger logger;

        public RoomsDistributedSqlCachedController(ApiDbContext context, ISimpleLogger logger)
        {
