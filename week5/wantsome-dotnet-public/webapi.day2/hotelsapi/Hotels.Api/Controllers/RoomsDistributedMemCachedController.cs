namespace Hotels.Api.Controllers
{
    ...
    [Route("api/hotels/{hotelId}/dis-mem-cached-rooms")]
    [ApiController]
    public class RoomsDistributedMemCachedController : ControllerBase
    {
        private readonly ApiDbContext context;
        private readonly ISimpleLogger logger;

        public RoomsDistributedMemCachedController(ApiDbContext context, ISimpleLogger logger)
        {
